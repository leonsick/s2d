...
class YTVOSimg:
    ...
    def createIndex(self):
        ...
        print(self.dataset['annotations'][1].keys())
        print(self.dataset["videos"][0].keys())

        print("video id", self.dataset['annotations'][1]['video_id'])
        print("id of video", self.dataset['annotations'][1]['id'])
        print("id", self.dataset['videos'][0]['id'])

        print("length", self.dataset['annotations'][1]['length'])
        print("n segmentations", len(self.dataset['annotations'][1]['segmentations']))
        print("n filenames", len(self.dataset['videos'][0]['file_names']))
