...
_PREDEFINED_SPLITS_COCO_CA["coco_cls_agnostic"] = {
    "cls_agnostic_coco": ("coco/images/val2017", "coco/annotations/coco_cls_agnostic_instances_val2017.json"),
...
_PREDEFINED_SPLITS_IMAGENET["imagenet"] = {
    ...
    "imagenet_train_diffncut_v1": ("imagenet/train", "imagenet/annotations/train_imagenet_in1k_diffncut_mincut_sif_mask_confidence_merged.json"),
    # self-training round 1
    "imagenet_train_r1": ("imagenet/train", "imagenet/annotations/cutler_imagenet1k_train_r1.json"),
    "imagenet_train_diffncut_select_and_blend_r1": ("imagenet/train", "imagenet/annotations/cutler_imagenet1k_train_r1_diffncut_mincut_sif_mask_confidence_select_and_blend.json"),
    ...
    "imagenet_train_diffncut_ablation_kbr_r3_seedsweep": ("imagenet/train", "imagenet/annotations/cutler_imagenet1k_train_r3_diffncut_ablation_kbr_seedsweep.json"),
    "imagenet_train_diffncut_select_and_blend_r3": ("imagenet/train", "imagenet/annotations/cutler_imagenet1k_train_r3_diffncut_mincut_sif_mask_confidence.json"),
}
