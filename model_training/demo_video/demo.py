...
try:
    ...
    from videocutler.demo_video.predictor import VisualizationDemo
...
# python demo_video/demo.py --config-file configs/imagenet_video/ytvis2021_kd_video_mask2former_R50_cls_agnostic.yaml --input /mnt/hdd/leon/shared_datasets/ytvis2019/valid/JPEGImages/* --output /mnt/hdd/leon/outputs/vm2f_predictions/ytvis2019/val --save-frames True --save-masks True MODEl.WEIGHTS /mnt/hdd/leon/outputs/mseg_m2f/ytvis2019/sparse_evalontrain/dense1/model_0020999.pth
def get_parser():
...
if __name__ == "__main__":
    ...
    # Unfreeze the cfg to allow modifications
    cfg.defrost()
